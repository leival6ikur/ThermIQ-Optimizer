    ...
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200 p-4">
        <div className="flex items-start justify-between">
          <div>
            <h3 className="text-sm font-semibold text-blue-900 mb-1">Current Weather</h3>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-blue-700 capitalize">{current.description}</div>
              </div>
            </div>
          </div>
      ...
      {showForecast && forecast.length > 0 && (
        <div className="bg-white rounded-lg border p-4">
          <h4 className="text-sm font-semibold text-gray-900 mb-3">24h Forecast</h4>
            ...
            {forecast.slice(0, 8).map((f, i) => {
              ...
              return (
                <div key={i} className="text-center">
                  ...
                  <div className="text-sm font-semibold">{f.temperature.toFixed(0)}°</div>
                </div>
              );
            })}
          </div>
      ...
      {showHeatingLoad && heatingLoads.length > 0 && (
        <div className="bg-white rounded-lg border p-4">
          <h4 className="text-sm font-semibold text-gray-900 mb-3">Heating Load Forecast</h4>
            ...
            {heatingLoads.slice(0, 6).map((load, i) => {
              ...
              return (
                <div key={i} className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-gray-900">{load.temperature.toFixed(1)}°C</span>
                  <span
                  ...
                  <span className="text-xs text-gray-500 capitalize">{load.description}</span>
                </div>
              );
            })}
          </div>
